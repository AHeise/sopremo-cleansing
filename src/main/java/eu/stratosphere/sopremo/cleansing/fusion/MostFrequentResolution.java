...
public class MostFrequentResolution extends ConflictResolution {
	public static class MostFrequentResolutionSerializer extends Serializer<MostFrequentResolution> {
		FieldSerializer<MostFrequentResolution> fieldSerializer;

		public MostFrequentResolutionSerializer(Kryo kryo, Class<MostFrequentResolution> type) {
			fieldSerializer = new FieldSerializer<MostFrequentResolution>(kryo, type);
		}

		@Override
		public void write(Kryo kryo, com.esotericsoftware.kryo.io.Output output, MostFrequentResolution object) {
		...
		@Override
		public MostFrequentResolution read(Kryo kryo, Input input, Class<MostFrequentResolution> type) {
			MostFrequentResolution object = fieldSerializer.read(kryo, input, type);
			MapSerializer mapSerializer = new MapSerializer();
			mapSerializer.setKeyClass(IJsonNode.class, null);
			mapSerializer.setValueClass(Double.class, null);
			@SuppressWarnings("unchecked")
			Map<IJsonNode, Double> backingMapCopy = kryo.readObject(input, HashMap.class, mapSerializer);
		...
		@Override
		public MostFrequentResolution copy(Kryo kryo, MostFrequentResolution original) {
			MostFrequentResolution copy = this.fieldSerializer.copy(kryo, original);
