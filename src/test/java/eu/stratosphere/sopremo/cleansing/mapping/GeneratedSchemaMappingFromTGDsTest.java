...
public class GeneratedSchemaMappingFromTGDsTest extends SopremoOperatorTestBase<ExampleMapping> {
	@Override
...
//		sopremoPlan.getExpectedOutput(0).
//			addObject("v1", 
//					  new ObjectNode().put("biographyId_o", TextNode.valueOf("A000049")).put("worksFor_o", TextNode.valueOf("CompanyABC"))
//					  ); 
