...
public class EntityMappingIT9 extends MeteorIT {
	...
	@Test
	public void testNestedRealtionsSupport() throws IOException {
		...
		String query = "using cleansing;"+
				...
				"    worksFor: all({LE: $usCongressMembers.party, startYear : split($usCongressMembers.id, '-')[0] as int,"+
