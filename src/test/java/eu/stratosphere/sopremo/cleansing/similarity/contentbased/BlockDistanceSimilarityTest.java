...
import eu.stratosphere.sopremo.cleansing.similarity.set.BlockDistanceSimilarity;

/**
 * Tests the {@link BlockDistanceSimilarity} class.
 * 
 * @author Arvid Heise
 */
public class BlockDistanceSimilarityTest extends SimilarityBaseTest {
	...
	public Similarity<?> getSimilarity() {
		return new BlockDistanceSimilarity();
	}
